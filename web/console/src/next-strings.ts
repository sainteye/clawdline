...
const words = {
  en: {
    ...
    transcriptJumpLatest: "Jump to latest",
    transcriptJumpNew: "New messages",
    ...
    sendEnterMoved:
      "Enter was not pressed: these words are no longer in the session's input line ({code}).",
  ...
  "zh-Hant": {
    ...
    transcriptJumpLatest: "跳到最新",
    transcriptJumpNew: "有新訊息",
    ...
    sendEnterMoved: "沒有按下 Enter：這段字已經不在 session 的輸入列（{code}）。",

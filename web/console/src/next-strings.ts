...
const words = {
  en: {
    ...
    endWorkFinished: "Completed in this Session:",
    endDirectOpen: "Unfinished direct to-dos ({count}):",
    endWorkReadyToClose: "Recorded Board work and direct to-dos are complete. If nothing outside Clawdline remains to deliver, this Session is ready to close safely.",
  ...
  "zh-Hant": {
    ...
    endWorkItem: "{title} · {project}",
    endWorkFinished: "這個 Session 已完成：",
    endDirectOpen: "尚未完成的直接待辦（{count}）：",
    endWorkReadyToClose: "看板項目與直接待辦都已完成。若沒有 Clawdline 以外尚未交付的工作，現在可以安全關閉這個 Session。",

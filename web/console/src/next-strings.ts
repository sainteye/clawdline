...
const words = {
  en: {
    ...
    cloudPairFromBrowserStep1: "Generate one command here, then run it in that machine's terminal.",
    ...
    cloudPairGenerate: "Generate the command",
    cloudPairWhy:

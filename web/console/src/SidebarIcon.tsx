...
export function SidebarIcon({ name }: { name: SidebarIconName }) {
  return (
    ...
    >
      ...
      {name === "settings" && (
        <>
          <path d="M9.55 3.65 10.1 2h3.8l.55 1.65 1.35.78 1.7-.34 1.9 3.3-1.15 1.3v1.56l1.15 1.3-1.9 3.3-1.7-.34-1.35.78-.55 1.65h-3.8l-.55-1.65-1.35-.78-1.7.34-1.9-3.3 1.15-1.3V8.69L4.6 7.39l1.9-3.3 1.7.34Z" transform="translate(0 1.68) scale(1 .86)" />

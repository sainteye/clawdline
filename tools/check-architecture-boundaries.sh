...
# 528 is this merged tree counted with the awk above.
[ "$manifest_group_count" -eq 528 ] \
  || architecture_guard_fail "ordered group manifest has $manifest_group_count entries; expected 528"

...
struct Korean: Copy {
    ...
    let settingsOrchestratorPermissionHint = "자식 세션의 탭은 아무도 보고 있지 않아서, 승인을 기다리며 멈춘 세션은 시간이 다 될 때까지 멈춰 있습니다. 그래서 기본값은 첫 번째가 아니라 가운데입니다. 작업은 이보다 조심스럽게 요청할 수 있지만, 이보다 더 나아갈 수는 없습니다."
    let settingsOrchestratorPermissionAsk = "한 걸음마다 묻기"
    let settingsOrchestratorPermissionAuto = "무엇을 물을지 스스로 판단하게"

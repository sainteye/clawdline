...
struct Hindi: Copy {
    ...
    let webVoiceSlow = "फिर से चालू होने के बाद पहली बार पहले model पढ़ा जाता है — क़रीब बारह सेकंड।"
    let webVoiceLimit = "एक रिकॉर्डिंग ज़्यादा से ज़्यादा {n} मिनट की होती है। जितना है उतना लिखा जा रहा है।"
    let webVoiceEmpty = "उसमें कुछ सुनाई नहीं दिया।"
    let webVoiceTooShort = "वह इतना छोटा था कि कुछ सुनाई ही नहीं दिया।"
    let webVoiceDenied = "माइक्रोफ़ोन को मना कर दिया गया। उसे वापस चालू करने की जगह इसी browser की, इस साइट के लिए रखी गई सेटिंग्ज़ हैं।"
    ...
    let webVoiceInsecure = "माइक्रोफ़ोन के लिए सुरक्षित कनेक्शन चाहिए। Clawdline को https पर खोलिए, फिर यह चलेगा।"
    let webVoiceUnsupported = "यह browser आवाज़ रिकॉर्ड नहीं कर सकता।"
    let webVoiceBusy = "Mac पहले से ऐसी दो लिख रहा है। थोड़ी देर बाद कोशिश कीजिए।"

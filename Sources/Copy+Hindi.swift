...
struct Hindi: Copy {
    ...
    let settingsOrchestratorPermissionHint = "चाइल्ड के टैब को कोई नहीं देख रहा होता, इसलिए मंज़ूरी के लिए रुका हुआ session समय ख़त्म होने तक रुका ही रहता है — इसीलिए बीच वाला विकल्प डिफ़ॉल्ट है, पहला नहीं। कोई काम इससे कम माँग सकता है, ज़्यादा नहीं।"
    let settingsOrchestratorPermissionAsk = "हर क़दम पर पूछे"
    let settingsOrchestratorPermissionAuto = "खुद तय करे कि क्या पूछना है"

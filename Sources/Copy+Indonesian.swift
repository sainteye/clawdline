...
struct Indonesian: Copy {
    ...
    let settingsOrchestratorPermissionHint = "Tidak ada yang menonton tab sesi anak, jadi yang berhenti menunggu persetujuan akan berhenti sampai waktunya habis — itulah sebabnya pilihan tengah yang jadi bawaan, bukan yang pertama. Sebuah tugas boleh meminta lebih sedikit dari ini, tidak pernah lebih."
    let settingsOrchestratorPermissionAsk = "Tanya sebelum tiap langkah"
    let settingsOrchestratorPermissionAuto = "Biar dia menimbang apa yang perlu ditanyakan"

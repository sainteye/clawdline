...
struct Indonesian: Copy {
    ...
    let webVoiceSlow = "Yang pertama setelah dinyalakan ulang memuat modelnya dulu — sekitar dua belas detik."
    let webVoiceLimit = "Satu rekaman paling lama {n} menit. Yang sudah ada ditranskripsi."
    let webVoiceEmpty = "Tidak ada yang terdengar di situ."
    let webVoiceTooShort = "Itu terlalu pendek untuk terdengar."
    let webVoiceDenied = "Mikrofonnya ditolak. Menyalakannya lagi ada di pengaturan yang peramban ini simpan untuk situs ini."
    ...
    let webVoiceInsecure = "Mikrofon butuh sambungan yang aman. Buka Clawdline lewat https dan ini jalan."
    let webVoiceUnsupported = "Peramban ini tidak bisa merekam suara."
    let webVoiceBusy = "Mac sudah mentranskripsi dua. Coba lagi sebentar lagi."

...
final class SettingsWindow: NSObject, NSWindowDelegate {
    ...
    ///
    /// There is no second row under it. A child dispatches nothing — see ``Orchestrator/depthFloor``
    /// — so "how many may it open" is not a question this window can ask any more, and a row that
    /// changed nothing would read as though it did.

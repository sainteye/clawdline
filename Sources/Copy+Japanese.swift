...
struct Japanese: Copy {
    ...
    let webProjectDeliveredSay = "いずれも Feature を仕上げていますが、ブランチに届いたという着地の記録がありません。作業は終わっていて、誰も取り込んでいないだけです。"
    let webProjectDeliveredNone = "待っているものはありません。このプロジェクトで仕上がった Feature には、すべて着地の記録があります。"
    let webProjectLanded = "着地済み"
    let webProjectLandedSay = "この納品が目的のブランチに届いたと root が記録しています。"

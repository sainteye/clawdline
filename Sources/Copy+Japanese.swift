...
struct Japanese: Copy {
    ...
    let webProjectDeliveredNone = "待っているものはありません。このプロジェクトで仕上がった Feature はすべて着地しています——root の記録によるか、git がすでにマージしたブランチによるかです。"
    let webProjectLanded = "着地済み"
    let webProjectLandedSay = "この納品が目的のブランチに届いたと root が記録しているか、その ブランチはすでに木の中だと git が言っています。"

...
enum RemotePage {
    ...
    static func strings(for request: RemoteServer.Request) -> RemoteServer.Response {
        ...
        add([
            ...
            "webStartMachine": t.webStartMachine,
            "webStartMachinePick": t.webStartMachinePick,
            "webStartMachineStale": t.webStartMachineStale,
            "webStartMachineNone": t.webStartMachineNone,
            "webMachineThisMac": t.webMachineThisMac,
            "webMachineMac": t.webMachineMac,
            "webMachineLinux": t.webMachineLinux,
            "webMachineLinuxAWS": t.webMachineLinuxAWS,
            "webDevices": t.webDevices,
            "webDevicesLede": t.webDevicesLede,
            "webDeviceOnline": t.webDeviceOnline,
            "webDevicePaired": t.webDevicePaired,
            "webDeviceNotPaired": t.webDeviceNotPaired,
            "webDevicePairingUnknown": t.webDevicePairingUnknown,
            "webDevicePairHelp": t.webDevicePairHelp,
            "webDeviceNewSession": t.webDeviceNewSession,
            "webDeviceVoiceHost": t.webDeviceVoiceHost,
            ...
            "webMachinesUnanswered": t.webMachinesUnanswered,
        ...
        add([
            ...
            "webInfoTapForDetails": t.webInfoTapForDetails,
            "webInfoCloseReasonWorking": t.webInfoCloseReasonWorking,
            "webInfoCloseReasonWaitingYou": t.webInfoCloseReasonWaitingYou,
            "webInfoCloseReasonTaskActive": t.webInfoCloseReasonTaskActive,
            "webInfoCloseReasonChildActive": t.webInfoCloseReasonChildActive,
            "webInfoCloseReasonTaskResult": t.webInfoCloseReasonTaskResult,
            "webInfoCloseReasonLanding": t.webInfoCloseReasonLanding,
            "webInfoCloseReasonCoordinationOwned": t.webInfoCloseReasonCoordinationOwned,
            "webInfoCloseReasonCoordinationWaiting": t.webInfoCloseReasonCoordinationWaiting,
            "webInfoCloseReasonHandoff": t.webInfoCloseReasonHandoff,
            "webInfoCloseReasonCompletion": t.webInfoCloseReasonCompletion,
            "webInfoCloseReasonDecision": t.webInfoCloseReasonDecision,
            "webInfoCloseReasonDirtyWorktree": t.webInfoCloseReasonDirtyWorktree,
            "webInfoCloseReasonTouchedFiles": t.webInfoCloseReasonTouchedFiles,
            "webInfoCloseReasonEvidence": t.webInfoCloseReasonEvidence,
            "webInfoCloseReasonAttestation": t.webInfoCloseReasonAttestation,
            "webInfoCloseReasonOther": t.webInfoCloseReasonOther,
            ...
            "webInfoFastMode": t.webInfoFastMode,
            "webInfoFastStandard": t.webInfoFastStandard,
            "webInfoFastOn": t.webInfoFastOn,
            "webInfoFastUnreadable": t.webInfoFastUnreadable,
            "webInfoFastSent": t.webInfoFastSent,
            "webInfoFastBusy": t.webInfoFastBusy,
        ...
        add([
            ...
            "webProjectNothingToLand": t.webProjectNothingToLand,
            "webProjectNothingToLandSay": t.webProjectNothingToLandSay,
            ...
            "webProjectWorkLine": t.webProjectWorkLine,
            "webProjectNeeds": t.webProjectNeeds,
            "webProjectNeedsLanding": t.webProjectNeedsLanding,
            "webProjectNeedsNothingToLand": t.webProjectNeedsNothingToLand,
            "webProjectNeedsNoRecord": t.webProjectNeedsNoRecord,
            ...
            "webLedger": t.webLedger,
            "webLedgerLede": t.webLedgerLede,
            "webLedgerLoading": t.webLedgerLoading,
            "webLedgerUnavailable": t.webLedgerUnavailable,
            ...
            "webLedgerReceiptsTruncated": t.webLedgerReceiptsTruncated,
            "webLedgerFeature": t.webLedgerFeature,
            "webLedgerTasks": t.webLedgerTasks,
            "webLedgerSeen": t.webLedgerSeen,
            "webLedgerFindings": t.webLedgerFindings,
            "webLedgerReviewedClean": t.webLedgerReviewedClean,
            "webLedgerVerification": t.webLedgerVerification,
            "webLedgerVerificationSay": t.webLedgerVerificationSay,
            "webLedgerTokens": t.webLedgerTokens,
            "webLedgerImplementation": t.webLedgerImplementation,
            "webLedgerReview": t.webLedgerReview,
            "webLedgerUndeclared": t.webLedgerUndeclared,
            "webLedgerUndeclaredSay": t.webLedgerUndeclaredSay,
            "webLedgerNoRecord": t.webLedgerNoRecord,
            "webLedgerNoRecordSay": t.webLedgerNoRecordSay,
            "webLedgerNotMeasurable": t.webLedgerNotMeasurable,
            "webLedgerNotMeasurableSay": t.webLedgerNotMeasurableSay,
            "webLedgerAtLeast": t.webLedgerAtLeast,
            "webLedgerFloorSay": t.webLedgerFloorSay,
            "webLedgerRows": t.webLedgerRows,
            "webLedgerUnattributed": t.webLedgerUnattributed,
            "webLedgerUnattributedSay": t.webLedgerUnattributedSay,
            "webLedgerVerdicts": t.webLedgerVerdicts,
            "webLedgerAxes": t.webLedgerAxes,
            "webLedgerEvidence": t.webLedgerEvidence,
            "webLedgerOpenLabel": t.webLedgerOpenLabel,
            "webLedgerNotFound": t.webLedgerNotFound,
            "webLedgerFailed": t.webLedgerFailed,
        ])
        ...
        add([
            "webPlan": t.webPlan,
            "webPlanLede": t.webPlanLede,
            "webPlanIncludes": t.webPlanIncludes,
            "webPlanRowMacs": t.webPlanRowMacs,
            "webPlanRowSessions": t.webPlanRowSessions,
            "webPlanRowViewers": t.webPlanRowViewers,
            "webPlanRowDispatches": t.webPlanRowDispatches,
            "webPlanRowHistory": t.webPlanRowHistory,
            "webPlanRowFleet": t.webPlanRowFleet,
            "webPlanRowTeam": t.webPlanRowTeam,
            "webPlanNoLimit": t.webPlanNoLimit,
            "webPlanIncluded": t.webPlanIncluded,
            "webPlanNotIncluded": t.webPlanNotIncluded,
            "webPlanHistoryNone": t.webPlanHistoryNone,
            "webPlanHistoryDays": t.webPlanHistoryDays,
            "webPlanMeter": t.webPlanMeter,
            "webPlanUpgrade": t.webPlanUpgrade,
            "webPlanManage": t.webPlanManage,
            "webPlanSignIn": t.webPlanSignIn,
            "webPlanRetry": t.webPlanRetry,
            "webPlanRecheck": t.webPlanRecheck,
            "webPlanFreeNote": t.webPlanFreeNote,
            "webPlanPaidNote": t.webPlanPaidNote,
            "webPlanProvisional": t.webPlanProvisional,
            "webPlanLoading": t.webPlanLoading,
            "webPlanActive": t.webPlanActive,
            "webPlanOnFree": t.webPlanOnFree,
            "webPlanNotForSale": t.webPlanNotForSale,
            "webPlanSignedOut": t.webPlanSignedOut,
            "webPlanSignedOutNote": t.webPlanSignedOutNote,
            "webPlanOpening": t.webPlanOpening,
            "webPlanPortalOpening": t.webPlanPortalOpening,
            "webPlanWaiting": t.webPlanWaiting,
            "webPlanConfirmed": t.webPlanConfirmed,
            "webPlanNotConfirmed": t.webPlanNotConfirmed,
            "webPlanAlready": t.webPlanAlready,
            "webPlanUnreadable": t.webPlanUnreadable,
            "webPlanFailSignedOut": t.webPlanFailSignedOut,
            "webPlanFailNotForSale": t.webPlanFailNotForSale,
            "webPlanFailNoPrice": t.webPlanFailNoPrice,
            "webPlanFailFree": t.webPlanFailFree,
            "webPlanFailNoAccount": t.webPlanFailNoAccount,
            "webPlanFailCheckout": t.webPlanFailCheckout,
            "webPlanPortalNone": t.webPlanPortalNone,
            "webPlanPortalProvider": t.webPlanPortalProvider,
        ...
        // The Cloud failure contract and the Cloud status sheet.
        add([
            "webFailUnknown": t.webFailUnknown,
            "webFailWithTag": t.webFailWithTag,
            "webFailTap": t.webFailTap,
            "webFailMachineOffline": t.webFailMachineOffline,
            "webFailReconnecting": t.webFailReconnecting,
            "webFailSignedOut": t.webFailSignedOut,
            "webFailForbidden": t.webFailForbidden,
            "webFailRateLimited": t.webFailRateLimited,
            "webFailTooLarge": t.webFailTooLarge,
            "webFailNoAnswer": t.webFailNoAnswer,
            "webFailReplyLost": t.webFailReplyLost,
            "webFailClock": t.webFailClock,
            "webFailClockIn": t.webFailClockIn,
            "webFailKeyMismatch": t.webFailKeyMismatch,
            "webFailOtherTab": t.webFailOtherTab,
            "webFailUnknownSender": t.webFailUnknownSender,
            "webFailMacBusy": t.webFailMacBusy,
            "webFailMacWritesOff": t.webFailMacWritesOff,
            "webFailReadOnly": t.webFailReadOnly,
            "webFailRoster": t.webFailRoster,
            "webFailNoMac": t.webFailNoMac,
            "webFailWhichMac": t.webFailWhichMac,
            "webFailMismatch": t.webFailMismatch,
            "webFailDecrypt": t.webFailDecrypt,
            "webFailNotFound": t.webFailNotFound,
            "webCloudStatus": t.webCloudStatus,
            "webCloudStatusSay": t.webCloudStatusSay,
            "webCloudStatusOpen": t.webCloudStatusOpen,
            "webCloudStatusBrowser": t.webCloudStatusBrowser,
            "webCloudStatusCommands": t.webCloudStatusCommands,
            "webCloudStatusNoCommands": t.webCloudStatusNoCommands,
            "webCloudStatusReading": t.webCloudStatusReading,
            "webCloudStatusReadFailed": t.webCloudStatusReadFailed,
            "webCloudStatusOldMac": t.webCloudStatusOldMac,
            "webCloudStatusKeyDrift": t.webCloudStatusKeyDrift,
            "webCloudStatusRepair": t.webCloudStatusRepair,
            "webCloudStatusConnection": t.webCloudStatusConnection,
            "webCloudStatusLastRefusal": t.webCloudStatusLastRefusal,
            "webCloudStatusClosed": t.webCloudStatusClosed,
            "webCloudStatusClock": t.webCloudStatusClock,
            "webCloudStatusToken": t.webCloudStatusToken,
            "webCloudStatusKey": t.webCloudStatusKey,
            "webCloudStatusDropped": t.webCloudStatusDropped,
            "webCloudStatusNoDrops": t.webCloudStatusNoDrops,
            "webCloudStatusMac": t.webCloudStatusMac,
        ])

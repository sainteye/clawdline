...
struct Russian: Copy {
    ...
    let settingsOrchestratorPermissionHint = "На вкладку дочерней сессии никто не смотрит, поэтому та, что остановилась ради подтверждения, стоит до истечения времени. По умолчанию третий пункт: файлы, ради которых её и отправили, она пишет не спрашивая, а всё остальное по-прежнему проходит через её собственное суждение. Задача может попросить меньше этого, но не больше."

...
struct Turkish: Copy {
    ...
    let webProjectDeliveredSay = "Bunlar bir Feature'ı bitirdi ve hiçbir iniş kaydı işin bir dala ulaştığını söylemiyor. İş bitmiş; kimse birleştirmemiş."
    let webProjectDeliveredNone = "Burada bekleyen bir şey yok: bu projede biten her Feature'ın bir iniş kaydı var."
    let webProjectLanded = "İnmiş"
    let webProjectLandedSay = "Bir root, teslimatın hedef dalına ulaştığını kaydetti."

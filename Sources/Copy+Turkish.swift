...
struct Turkish: Copy {
    ...
    let settingsOrchestratorPermissionHint = "Bir alt oturumun sekmesine kimse bakmıyor; onay için duran bir oturum süresi dolana kadar durur — bu yüzden varsayılan ilki değil, ortadaki. Bir görev bundan azını isteyebilir, fazlasını asla."
    let settingsOrchestratorPermissionAsk = "Her adımdan önce sor"
    let settingsOrchestratorPermissionAuto = "Neyi soracağına kendi karar versin"

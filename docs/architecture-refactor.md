...
|---|---:|---|
| ordered groups | 536 | `Tests/TestGroupManifest.swift`, counted by the guard |
...
| `RemoteServer.swift` ceiling | 5,726 | the receipt in `tools/check-architecture-boundaries.sh` |

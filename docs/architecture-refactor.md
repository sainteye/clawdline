...
|---|---:|---|
| ordered groups | 532 | `Tests/TestGroupManifest.swift`, counted by the guard |
| ordered runners | 32 | `Tests/main.swift`, counted by the guard |
| suite files | 45 | `Tests/*Tests.swift`, counted by the guard |

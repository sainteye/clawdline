<!-- retired-app-record: 舊 app 畫面的 1:1 復刻量測，量於 2026-09-17 至 09-18；該 app 已於 2026-09-19 停用，7717 無人監聽 -->

> **主體與時間：** 這份文件記錄的是 **舊 app 畫面的 1:1 復刻量測**，量於 **2026-09-17 至 09-18**。
...
| ⋯ 選單的「在 Mac 上顯示／Session 資訊／即時畫面／Git」 | 各自需要後端路由，目前 disabled 而非移除（2026-09-17 的記錄；之後都接上了，即時畫面經由 Clawdline Cloud 也在 2026-09-26 接上） |
...
瀏覽器。使用者要求改回在同一個視窗切換，不必另開瀏覽器。登入則交給常用瀏覽器（2026-09-27）：Cloud 分頁

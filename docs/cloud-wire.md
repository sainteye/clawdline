...
As of 2026-09-22, the hosted Work v2 console also carries eight explicit words. The read words are
`work.v2.items`, `work.v2.proposals`, and `work.v2.session-todos`; the person-only mutation words are
`work.v2.create`, `work.v2.assign`, `work.v2.proposal-resolve`, `work.v2.todo-create`, and

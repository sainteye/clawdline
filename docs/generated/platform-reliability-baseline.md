...
來源引用提交：`402b4954de1b52a60f419b5183f60ae2026f4389`。
來源範圍 SHA-256：`2e5ab601614fe70c8bfba1e3038860a391940cbdccce6ad03df611e5db29f769`。
工具 SHA-256：`a672f5da6727d9c14a9f7762853c512313ce48995c8a20039f38012ab295b495`。
...
- **source-derived**：
  ...
  - `Sources/CloudAppBridge.swift:440–448`；slice SHA-256 `21ba233e27062ca9cd21dd77dc3ae69407268b8ffddc0f76491e320f079d6980`。
  - `Sources/CloudAppBridge.swift:1109–1113`；slice SHA-256 `58504ef9ea6dd1627b87cd98de663707d38190e928e61b0d0e65ded4fca39c60`。
...
- **source-derived**：
  - `Sources/RemoteServer.swift:555–560`；slice SHA-256 `809c25ceafa41dcf951f1a64aed7b8de55b5d7d97e2198ebd2e7ce86950a1c42`。
  - `Sources/RemoteServer.swift:565–618`；slice SHA-256 `a36633fb23f30d6079fca2bb082b6d35050af66525a3192f968ce1a6f5cb74b0`。
  - `Sources/RemoteServer.swift:5566–5566`；slice SHA-256 `f51d92d14db18adf58729af5350df5b81ae3ccfee46a076b7cbd7796bd31e283`。
...
- **source-derived**：
  - `Sources/RemoteServer.swift:5427–5432`；slice SHA-256 `aa83071c47cfb0303bcd1ac0652e35be5e485d5fc876cd63b03ccbe31da608ba`。
  - `Sources/RemoteServer.swift:5442–5489`；slice SHA-256 `0c9d26aef7affa2aa56381c1b4e02f643d6e0e810772abeb5f143fb69953292f`。
  - `Sources/RemoteServer.swift:731–739`；slice SHA-256 `7f6beca1780fb6921227aff809fa9a9aa1a78be02872dc41f3a825c1fde71452`。
  - `Sources/RemoteServer.swift:5492–5508`；slice SHA-256 `1ea4c0fb7c2d0ba698647d66baef5d0f91e8a66da781e98b17dd6a4a26d9482c`。
  - `Sources/RemoteServer.swift:5555–5564`；slice SHA-256 `3fef466150f294172022c48b80a119ce8d4c048ba552e0dd620fdce6b779ea95`。
...
- **source-derived**：
  ...
  - `Sources/RemoteServer.swift:3332–3410`；slice SHA-256 `1bc144ead388a794abd1e6bd79486b57de72aa07b181c88874b07f95a7855048`。
...
- **source-derived**：
  - `Sources/RemoteServer.swift:4362–4399`；slice SHA-256 `3c055438cd43c41fe9d256ec8a771c0b62e71bfc233b48bbf775bb9df3364b91`。
  - `Sources/RemoteServer.swift:4215–4224`；slice SHA-256 `b46c966611141380b7924027284015f38af80ca5fd2231c4cb8b9095a6332540`。
  - `Sources/RemoteServer.swift:3701–3701`；slice SHA-256 `303a1dbde79ba7cd428db85803635dba2e8ce2e855d8ac88384d27b1d483fbfe`。
  - `Sources/RemoteServer.swift:3964–3964`；slice SHA-256 `553b36a769437f0e44673f2311acfd0d6e462d4b97781827b7a1b7193f0961db`。
...
- **source-derived**：
  - `Sources/CloudAppBridge.swift:1494–1567`；slice SHA-256 `e7be63dd3909f2cc87991e2d2c6350df0f3ac9df822e997f3b8185abcc99f24b`。
...
- **source-derived**：
  - `Sources/CloudAppBridge.swift:270–303`；slice SHA-256 `e560d6b2abecfc6c939fa8fedb6ae9bb31bad898e7ba55b8e75a2b1112ad3ca7`。
...
- **source-derived**：
  ...
  - `Sources/Orchestrator.swift:10038–10223`；slice SHA-256 `7d4da82405435739f2703d955737b3e20ab3e9397df8ed92c2bfc6f71163bcc7`。
...
- **source-derived**：
  - `Sources/Orchestrator.swift:10227–10300`；slice SHA-256 `4b0fc9f543a83d11a6b13d4d508fbcc1541cb90a6d8cc94799fc7a6384434a98`。
...
- **source-derived**：
  ...
  - `Sources/OrchestratorRegistry.swift:719–832`；slice SHA-256 `2836dc415e0e6db01e22d767304d031d89cc28736ab80e7ceff6490ab94992e0`。
  - `Tests/OrchestratorRecoveryTests.swift:1490–1490`；slice SHA-256 `afdb101b2116a038b7267f771c1bfd3f9189395c2b0a4184d0ae16244645a938`。
- **executable-test-derived**：`{"observation_count":null,"status":"not-run"}`。
- **measured-runtime**：`{"observation_count":null,"status":"not-measured"}`。
...
- **source-derived**：
  ...
  - `Sources/CloudAppBridge.swift:685–685`；slice SHA-256 `fb03a42f0f7170421077ef8cf7c0fc272abd355bb764e6df403f08af4c42cc1a`。
- **executable-test-derived**：`{"observation_count":null,"status":"not-run"}`。
- **measured-runtime**：`{"observation_count":null,"status":"not-measured"}`。
...
- **source-derived**：
  ...
  - `Sources/Coordinator.swift:1681–1744`；slice SHA-256 `0f892d8ca72a686e44ad5f83f1c1612f21b936cd9f97212f33483ce39a40ed28`。
...
- **source-derived**：
  - `Sources/RemoteServer.swift:5432–5442`；slice SHA-256 `8e7fc3414149906a3b5cb277b25f5ec9ce9857903d27b670c9b1ef73c0387b1d`。
- **executable-test-derived**：`{"observation_count":null,"status":"not-run"}`。
- **measured-runtime**：`{"observation_count":null,"status":"not-measured"}`。
...
- **source-derived**：
  - `Sources/Orchestrator.swift:10287–10287`；slice SHA-256 `6df2ea3a6d16d84234b2ec21b002e4067370f5932d516041633e841882c83db4`。
- **executable-test-derived**：`{"observation_count":null,"status":"not-run"}`。
- **measured-runtime**：`{"observation_count":null,"status":"not-measured"}`。
...
| 檔案 | bytes | SHA-256 |
|---|---:|---|
| `Sources/CloudAppBridge.swift` | 95228 | `03b5abdabb0e0ddf6708ac25b509847e57ffc37f3c173bdf2ebc0682cae7d220` |
...
| `Sources/Coordinator.swift` | 96364 | `f1427979b4897a17d6796643acc596f14ced538ab6e472aad186d8d9f78397a7` |
| `Sources/Orchestrator.swift` | 590214 | `adedd015b38ba301a647cfe5635e0c1146001091cab1bed3111cda5181da9c83` |
| `Sources/OrchestratorPersistence.swift` | 19385 | `375628d34df7a2b7679b1e5519d2cfd81f92a3ba86df62b12ae95dfd43d9482c` |
| `Sources/OrchestratorRegistry.swift` | 71132 | `e8fe2cbe68e7752343863291dfa5f787df9195cc65c671c471a8eadfbadb2401` |
...
| `Sources/RemoteServer.swift` | 331231 | `761da7a649f86d981576643e02df562c55aa461791598ff3daa018850871e568` |
...
| `Tests/OrchestratorRecoveryTests.swift` | 98286 | `5c966c328f60fdd2404ec0fb41c43eedfd2ba4af3e118a32e43545f9278d27f5` |

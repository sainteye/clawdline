...
/// A small, dependency-free SHA-256 implementation used to bind durable sealed ingress bytes.
/// Package verification still uses OpenSSL; keeping this implementation local avoids adding a
/// network-fetched SwiftPM dependency to the sealed Linux build graph.
enum LinuxSHA256 {

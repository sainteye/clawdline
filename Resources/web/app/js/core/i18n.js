...
export var T = {
    ...
    webProjectDeliveredSay: "These finished a Feature, and no landing record says the work reached a branch. It is done; nothing merged it.",
    webProjectDeliveredNone: "Nothing is waiting here: every finished Feature under this Project has a landing record.",
    webProjectLanded: "Landed",
    webProjectLandedSay: "A root recorded that the delivery reached its target branch.",

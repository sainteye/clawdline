...
export var T = {
    ...
    webMakeClawdfather: "Make this session Clawdfather",
    webClawdfatherIs: "This session is {name}",
    webConfirmClawdfatherTitle: "Make this session Clawdfather?",
    webConfirmClawdfatherSay: "One instruction is typed into the session. It reads the machine coordinator record itself and registers, or reconnects an offline one — never taking over a coordinator that is still live.",
    webClawdfatherAsk: "Please make this session this Mac's Clawdfather — the machine coordinator. Your own terminal-neutral session id is {id}. Follow the “Becoming Clawdfather” recipe in docs/orchestrator.md, also carried in the Clawdline skill: read GET /v1/orchestrator/coordinator with the orchestrator token from ~/.config/clawdline/orchestrator-token, register when none is configured, reconnect with rebind when the recorded one is offline, and never take over one that is still online. Then say what happened.",
    webClawdfatherAsked: "Asked the session to become Clawdfather",

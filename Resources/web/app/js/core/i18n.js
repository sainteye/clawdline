...
export var T = {
    ...
    webProjectDeliveredNone: "Nothing is waiting here: every finished Feature under this Project has landed, by a root's record or by a branch git has already merged.",
    webProjectLanded: "Landed",
    webProjectLandedSay: "A root recorded that the delivery reached its target branch, or git says that branch is already in the tree.",
